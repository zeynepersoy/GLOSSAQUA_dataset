...
## Set the environment
setwd("C:/Users/10047352/OneDrive - Universitat de Vic/Documentos/Project_ACROSS/Data paper/Redaction/Flow diagram & Map")
...
## Load the data
Source <- read.table('SizeAcross_DataSource_01Dec2023.txt')
Sample <- read.table('SizeAcross_Sample_01Dec2023.txt')
Size <- read.table('SizeAcross_Size_01Dec2023.txt')
...
write.csv(Size_Sample , "C:/Users/10047352/OneDrive - Universitat de Vic/Documentos/Project_ACROSS/Data paper/Redaction/Flow diagram & Map/Data_Size Across_for flow diagram_01Dec2023.csv", row.names = TRUE)
...
Full <- read.csv("Data_Size Across_for flow diagram_01Dec2023.csv", header = T)
