...
ggsave(here("data", "Figure 1.png"), width = 10, height = 10, units = 'in', dpi= 300)
...
ggsave(here("data", "Figure 3.png"), width = 5, height = 5, units = 'in', dpi= 300)
...
ggsave(here("data", "Figure 4.png"), width = 12, height = 6, units = 'in', dpi= 300)
